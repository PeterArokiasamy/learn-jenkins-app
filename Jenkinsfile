pipeline {
    ...
    environment {
        ...
        AWS_ECS_SERVICE_PROD = 'LearnJenkinsApp-TD-Prod-service-dmskjm5n'
        AWS_ECS_TD_PROD = 'LearnJenkinsApp-TD-Prod'
        AWS_DOCKER_REGISTRY ='965496216011.dkr.ecr.us-east-1.amazonaws.com'
    }
    ...
    stages {
        ...
        stage('Deploy staging') {
            agent {
                docker {
                    image 'my-playwright'
                    reuseNode true
                    //To connect to Netlify API for node-jq
                    args '--dns 8.8.8.8'
                }
            }

            environment {
                //As of now dummy values
        ...
        stage('Deploy prod') {
            ...
            environment {
                CI_ENVIRONMENT_URL = 'https://peterarokia-learn-jenkins.netlify.app'
            }
